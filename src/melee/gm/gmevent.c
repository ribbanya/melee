...
void onEnterCss(GameModeState* arg0)
{
    ...
    gm_801B06B0(css, 0xE, temp_r31->x2, 0, temp_r31->x3, temp_r31->nametag, 0,
                temp_r31->x6);
    if (temp_r31->x44 == 1) {
...
void onExitCss(GameModeState* arg0)
{
    ...
    gm_801B0730(temp_r3, &temp_r31->x2, NULL, &temp_r31->x3,
...
void onEnterVs(GameModeState* arg0)
{
    ...
    md->rules.timer_enabled = levels[level]->x8->x0_6;
...
void gm_801BC754(HSD_GObj* gobj)
{
    ...
    case 1:
        ...
        if (temp_r28_2->xB_0) {
            var_r0 = false;
        } else if (temp_r3->x24C8.timer_enabled && gm_8016AEEC() == 0 &&
                   gm_8016AEFC() == 0x3B)
        {
            var_r0 = true;
        } else {
    ...
    case 2:
        ...
        if (temp_r28_3->xB_0) {
            var_r0_2 = false;
        } else if (temp_r3_2->x24C8.timer_enabled && gm_8016AEEC() == 0 &&
                   gm_8016AEFC() == 0x3B)
        {
            var_r0_2 = true;
        } else {
...
void gm_801BCC9C(HSD_GObj* arg0)
{
    ...
    if (gmMainLib_804D3EE0->vs.unk_530.xB_2) {
        ev->x10 -= 1;
        if (ev->x10 < 0) {
...
void gm_801BD028(HSD_GObj* arg0)
{
    ...
    if (ev->xB_0) {
        cond = 0;
    } else if (rules->x24C8.timer_enabled && gm_8016AEEC() == 0 &&
               gm_8016AEFC() == 0x3B)
    {
        cond = 1;
    } else {
...
void gm_801BDE94(HSD_GObj* arg0)
{
    ...
    }
    {
        ...
        if (ev2->xB_0) {
            do_end = 0;
        } else if (info->x24C8.timer_enabled && gm_8016AEEC() == 0 &&
                   gm_8016AEFC() == 0x3B)
        {
            do_end = 1;
        } else {
...
void gm_801BE638(HSD_GObj* gobj)
{
    ...
    if (temp_r28_4->xB_0) {
        var_r0 = 0;
    } else if (temp_r3_4->x24C8.timer_enabled && gm_8016AEEC() == 0 &&
               gm_8016AEFC() == 0x3B)
    {
        var_r0 = 1;
    } else {
...
void gm_801BEA10(int arg0)
{
    Player_SetPlayerAndEntityCpuType(
        arg0, (*gm_804D6900)[gmMainLib_804D3EE0->vs.unk_530.unk_535]->xC->x16);
}
...
{
    gmMainLib_804D3EE0->vs.unk_530.x18 = arg0;
}

void gm_801BEB74(u8 arg0)
{
    gmMainLib_804D3EE0->vs.unk_530.unk_535 = arg0;
}

u8 gm_801BEB80(void)
{
    return gmMainLib_804D3EE0->vs.unk_530.unk_535;
}
