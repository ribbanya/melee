 ...
 * should still match <rei wolf> oh wow rly <Altafen#6776> yea (i didn't know
 * linkers could do that especially linkers from 1998) <Altafen#6776> (i should
 * write a linker) <rei wolf> i have never heard of that being a thing at all
 */
...
ItemStateTable it_803F6B60[1] = { 0, itNesspkfirepillar_UnkMotion0_Anim,
                                 ...
                                 f32 facing_dir)
{
    ...
    SpawnItem spawnitem;
    PAD_STACK(0x10);
    itNesspkfirepillar_INLINE_SpawnItem_Init(&spawnitem, offset, facing_dir,
                                             parent1_gobj, parent2_gobj);
