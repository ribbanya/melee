...
ItemStateTable it_803F9328[] = {
    ...
    { -1, 0, itKyasarinegg_UnkMotion1_Phys, itKyasarinegg_UnkMotion1_Coll },
    { -1, 0, 0, 0 },
    { 1, 0, itKyasarinegg_UnkMotion3_Phys, itKyasarinegg_UnkMotion3_Coll },
    { 2, itKyasarinegg_UnkMotion4_Anim, 0, 0 },
};
