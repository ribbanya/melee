...
ItemStateTable it_803F7C70[] = {
    { 0, itFreezer_UnkMotion0_Anim, itFreezer_UnkMotion0_Phys,
      itFreezer_UnkMotion0_Coll },
    { 1, itFreezer_UnkMotion1_Anim, itFreezer_UnkMotion1_Phys,
      itFreezer_UnkMotion1_Coll },
    { 2, itFreezer_UnkMotion2_Anim, itFreezer_UnkMotion2_Phys,
      itFreezer_UnkMotion2_Coll }
};
...
void itFreezer_802CCF9C(Item_GObj* gobj)
{
    ...
    itFreezer_802CD2EC(gobj);
    it_80279CDC(gobj, attrs->x0);
}

void itFreezer_802CCFFC(Item_GObj* gobj) {}

void itFreezer_802CD000(Item_GObj* gobj, Item_GObj* ref_gobj)
{
...
{
    it_8026E15C(gobj, itFreezer_802CCFFC);
    return false;
}

void itFreezer_802CD090(Item_GObj* gobj)
{
    Item* item = GET_ITEM(gobj);
...
void itFreezer_802CD12C(HSD_GObj* gobj)
{
    Item* item = GET_ITEM(gobj);
...
void itFreezer_802CD290(Item_GObj* gobj)
{
    Item* item = GET_ITEM(gobj);
    if (item->xDD4_itemVar.freezer.x60 <= 0) {
        HSD_JObj* jobj = HSD_GObjGetHSDObj(gobj);
...
{
    return it_8027A118(gobj, (void (*)(HSD_GObj*)) itFreezer_802CCFFC);
}
