...
void itPeachToad_Logic91_Destroyed(Item_GObj* item_gobj)
{
    Item* item;
...
void itPeachToad_Logic91_PickedUp(Item_GObj* item_gobj)
{
    u8 _[8];
...
void itPeachToad_Logic91_EvtUnk(Item_GObj* item_gobj, Item_GObj* ref_gobj)
{
