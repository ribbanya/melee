...
void mnCharSel_8025DB34(u8 arg0)
{
    ...
    if (mnCharSel_804D6CF5 == 1) {
            ...
            mnCharSel_803F0DFC.doors[arg0].p_kind_prev)
        {
            ...
            case 0:
                if (gmMainLib_GetGameRules()->handicap != 0) {
                    ...
                    anim_frame =
                        (f32) mnCharSel_804D6CB0->vs.start.players[arg0]
                            .cpu_level;
        ...
        if (mnCharSel_804D6CB0->vs.start.rules.is_teams == 0) {
            /* FFA mode */
            s32 port_color_idx;
            ...
            mnCharSel_804D6CB0->vs.start.players[arg0].team =
                ...
                if (timer == 0) {
                    ...
                    if (rules->handicap != 0) {
...

                        {
                            ...
                            fval =
                                (f32) mnCharSel_804D6CB0->vs.start.players[i]
                                    .cpu_level;
...
s32 mnCharSel_8025FDEC(u8 door)
{
    ...
    if (c_kind < CKind_Playable_Count) {
        ...
        if (mnCharSel_804D6CF6 != 3 && mnCharSel_804D6CF6 != 4) {
            ...
            lbAudioAx_80023870(icons[sel].sfx, 0x7F, 0x40, sel + 0x8A);
            gm_80168C5C(icons[sel].char_kind);
        }
        return 0;
    }
    return 1;
    ...
    if (input & HSD_PAD_X) {
        ...
        do {
            if (mnCharSel_803F0DFC.doors[door].costume != 0) {
                ...
                mnCharSel_803F0DFC.doors[door].costume =
                    gm_GetNumCostumesForCKind(icons[mnCharSel_803F0DFC.doors[door].sel_icon]
                                    .char_kind) -
                    1;
            }
        } while (isDuplicateCostume(door));
                                       ...
                                       HSD_JObj** color_jobj)
{
...

    {
        ...
        } else if (mnCharSel_804D6CB0->vs.start.rules.is_teams == 0) {
            color_idx = cursor->x4;
        } else {
            color_idx =
                mnCharSel_804D50E0[mnCharSel_803F0DFC.doors[cursor->x4].team];
        }
                                       ...
                                       Point3d* pos, bool is_handicap)
{
    ...
    if (is_handicap) {
        mnCharSel_804D6CB0->vs.start.players[door_idx].handicap =
            (s32) ((0.8f * pos->x) + 0.5f) + 1;
        anim_frame =
            (u8) mnCharSel_804D6CB0->vs.start.players[door_idx].handicap;
    } else {
        mnCharSel_804D6CB0->vs.start.players[door_idx].cpu_level =
            (s32) ((0.8f * pos->x) + 0.5f) + 1;
        anim_frame = mnCharSel_804D6CB0->vs.start.players[door_idx].cpu_level;
    }
...
void mnCharSel_CursorThink(HSD_GObj* gobj)
{
    ...
    if (mnCharSel_804D6CF6 == 0) {
                ...
                if (cursor->x5 != 3) {
                    ...
                    if (cursor->x5 == 1) {
                        ...
                        if (door <= 3U) {
                            ...
                            cpu_door = door - 4;
                            mnCharSel_803F0DFC.doors[cpu_door]
                    ...
                    if (mnCharSel_803F0DFC.doors[cursor->x4].p_kind == 0) {
                        ...
                        mnCharSel_804D6CB0->vs.start.players[cursor->x4]
                            .nametag = 0x78;
                        mnCharSel_803F0E8C[cursor->x4].data->use_tag = 0;
                    }
                    mnCharSel_8025DB34(cursor->x4);
                    if (mnCharSel_803F0E8C[cursor->x4].data->state != 0) {
                        mnCharSel_803F0E8C[cursor->x4].data->state = 4;
                    }
        ...
        {
            current_tag = mnCharSel_803F0E8C[cursor->x4].data;
            if (current_tag->state != 0) {
                if (mnCharSel_804D6CF5 == 1) {
                    ...
                    lb_80011E24(mnCharSel_804D6CC0, &sp98,
                                mnCharSel_803F0E8C[cursor->x4].list_joint, -1);
                }
                lb_8000B1CC(sp98, NULL, &sp88);

                if ((0.8f + sp88.y) < cursor->x10) {
                    mnCharSel_803F0E8C[cursor->x4].data->scroll_amt =
        ...
        {
            u8 port = cursor->x4;
            CSSTagData* tag = mnCharSel_803F0E8C[port].data;
            if (tag->state == 0) {
                if (cursor->x5 == 1) {
                    door = cursor->x6;
                    switch (door) {
                                    ...
                                    if (icon_count == 0x19) {
                                        ...
                                        while (true) {
                                            mnCharSel_803F0DFC.doors[door]
                                                .costume =
                                                HSD_Randi((s32) gm_GetNumCostumesForCKind(
                    ...
                    case 7: {
                        ...
                        updateGrabbedSlider(
                            cursor, &mnCharSel_803F0DFC.doors[slider_door],
                    ...
                    case 0xB: {
                        s32 hc_door = door - 8;
                        updateGrabbedSlider(
                            cursor, &mnCharSel_803F0DFC.doors[hc_door],
...
void fn_80262648(HSD_GObj* gobj)
{
...

    {
        ...
        } else if (carrier.css->vs.start.rules.is_teams == 0) {
            if (p_kind == 1) {
                model->x6 = 8;
            } else {
                model->x6 = door;
...
s32 mnCharSel_802640A0(void)
{
    ...
    if ((u8) mnCharSel_804D6CF4 != 0) {
        ...
        for (i = 0; i < num_players; i++) {
            mnCharSel_804D6CB0->vs.start.players[i].handicap = 9;
        }
    }
    ...
    if (mnCharSel_804D6CB0->match_type == 0x17) {
        ...
        if ((s8) ck >= CKind_Playable_Count || gm_IsCKindUnlocked(ck) == 0) {
            ...
            mnCharSel_804D6CB0->vs.start.players[mnCharSel_804D6CF1].color =
                HSD_Randi((s32) gm_GetNumCostumesForCKind(char_kinds[icon_off]));
        }
    }
            ...
            jobj = HSD_JObjLoadJoint(ANIM[2].joint);
            {
                ...
                for (found = 0; found < 0x19; found++) {
                    if (mnCharSel_804D6CB0->vs.start.players[player].ckind ==
                        ...
                        gm_IsCKindUnlocked(
                            mnCharSel_804D6CB0->vs.start.players[player]
                                .ckind) != 0)
                    {
                        break;
                    }
        ...
        case REG_ALLSTAR:
                                    ...
                                    mnCharSel_804D6CBC);
            {
                ...
                if (css->match_type == 0xD) {
                    ...
                    HSD_JObj* sp70;
                    data2.stocks =
                        css->vs.start.players[mnCharSel_804D6CF0].stocks;
    ...
    mnCharSel_804D6CF7 = 0;
    if (mnCharSel_804D6CF5 == 1) {
        mnCharSel_804D6CB0->vs.start.players[3].slot_type = 3;
        mnCharSel_804D6CB0->vs.start.players[2].slot_type = 3;
        mnCharSel_804D6CB0->vs.start.players[1].slot_type = 3;
        mnCharSel_804D6CB0->vs.start.players[0].slot_type = 3;
        mnCharSel_804D6CB0->vs.start.players[mnCharSel_804D6CF0].slot_type = 0;
    ...
    doors_done:;
        ...
        for (i = 0; i < (s32) mnCharSel_804D6CF5; i++) {
            ...
            {
                u8* cpu_level =
                    &mnCharSel_804D6CB0->vs.start.players[i].cpu_level;
                if (*cpu_level == 0) {
                    *cpu_level = 1;
                }
            }
            HSD_JObjSetTranslateX(
                sp108,
                1.25f *
                    (f32) (mnCharSel_804D6CB0->vs.start.players[i].cpu_level -
                           1));
        }
    }
    ...
    if (mnCharSel_804D6CF6 <= 1) {
        ...
        if (mnCharSel_804D6CF5 == 1) {
            ...
            for (i = 0; i < num_slots; i++) {
                slot_type = mnCharSel_804D6CB0->vs.start.players[i].slot_type;
                if (!(slot_type != 0 && slot_type != 1) &&
...
void mnCharSel_Scene_OnExit(void* unused)
{
    ...
    if (mnCharSel_804D6CF5 == 1) {
        type =
            mnCharSel_804D6CB0->vs.start.players[mnCharSel_804D6CF0].slot_type;
        ...
        type =
            mnCharSel_804D6CB0->vs.start.players[mnCharSel_804D6CF1].slot_type;
        if ((type == Gm_PKind_Human || type == Gm_PKind_Cpu) &&
        ...
        for (i = 0; i < num_slots; i++) {
            type = mnCharSel_804D6CB0->vs.start.players[i].slot_type;
            if ((type == Gm_PKind_Human || type == Gm_PKind_Cpu) &&
                mnCharSel_804A0BD0[i]->x5 == 0)
            {
                tmp |= lbAudioAx_80026E84(
