...
* Refrain from allowing AI to name fields in structs or other globally accessible identifiers.* It is recommended to discourage AI from attempting to match data sections and focus solely on code matches.
